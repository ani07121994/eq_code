 ...
 *       &lt;sequence>
 *         &lt;element name="LINENO" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string50" minOccurs="0"/>
 *         &lt;element name="LINETYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string25" minOccurs="0"/>
 *         &lt;element name="LINEPONUMBER" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string20" minOccurs="0"/>
 *         &lt;element name="POLINENUMBER" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="LINEDESCRIPTION" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string500" minOccurs="0"/>
 *         &lt;element name="QUANTITY" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="UOM" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string25" minOccurs="0"/>
 ...
 *         &lt;element name="TAXRATECODE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string10" minOccurs="0"/>
 *         &lt;element name="LINETAXAMOUNT" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="PROJECTNO" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string25" minOccurs="0"/>
 *         &lt;element name="TASKNO" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string25" minOccurs="0"/>
 *         &lt;element name="EXPENDITUREORG" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string200" minOccurs="0"/>
 *         &lt;element name="EXPENDITUREDATE" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="EXPENDITURETYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string200" minOccurs="0"/>
 *         &lt;element name="GLCODE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string100" minOccurs="0"/>
 *         &lt;element name="LINEAATT1" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT2" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT3" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT4" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT5" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT6" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT7" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT8" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT9" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="LINEAATT10" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string1000" minOccurs="0"/>
 *         &lt;element name="SUSPENSE_ACCOUNT_FLAG" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS}string25" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class APPSINVOICELINEREC {
    ...
    @XmlElementRef(name = "LINENO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineno;
    @XmlElementRef(name = "LINETYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> linetype;
    @XmlElementRef(name = "LINEPONUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineponumber;
    @XmlElementRef(name = "POLINENUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> polinenumber;
    @XmlElementRef(name = "LINEDESCRIPTION", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> linedescription;
    @XmlElementRef(name = "QUANTITY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> quantity;
    @XmlElementRef(name = "UOM", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> uom;
    @XmlElementRef(name = "UNITPRICE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> unitprice;
    @XmlElementRef(name = "LINETOTALAMOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> linetotalamount;
    @XmlElementRef(name = "TAXRATE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> taxrate;
    @XmlElementRef(name = "TAXRATECODE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> taxratecode;
    @XmlElementRef(name = "LINETAXAMOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> linetaxamount;
    @XmlElementRef(name = "PROJECTNO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> projectno;
    @XmlElementRef(name = "TASKNO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> taskno;
    @XmlElementRef(name = "EXPENDITUREORG", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> expenditureorg;
    @XmlElementRef(name = "EXPENDITUREDATE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> expendituredate;
    @XmlElementRef(name = "EXPENDITURETYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> expendituretype;
    @XmlElementRef(name = "GLCODE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> glcode;
    @XmlElementRef(name = "LINEAATT1", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt1;
    @XmlElementRef(name = "LINEAATT2", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt2;
    @XmlElementRef(name = "LINEAATT3", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt3;
    @XmlElementRef(name = "LINEAATT4", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt4;
    @XmlElementRef(name = "LINEAATT5", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt5;
    @XmlElementRef(name = "LINEAATT6", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt6;
    @XmlElementRef(name = "LINEAATT7", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt7;
    @XmlElementRef(name = "LINEAATT8", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt8;
    @XmlElementRef(name = "LINEAATT9", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt9;
    @XmlElementRef(name = "LINEAATT10", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> lineaatt10;
    @XmlElementRef(name = "SUSPENSE_ACCOUNT_FLAG", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/QFEQ_AP_INV_IMG_PROCESS", type = JAXBElement.class)
    protected JAXBElement<String> suspenseaccountflag;
    ...
    /**
     * Gets the value of the suspenseaccountflag property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getSUSPENSEACCOUNTFLAG() {
        return suspenseaccountflag;
    }

    /**
     * Sets the value of the suspenseaccountflag property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSUSPENSEACCOUNTFLAG(JAXBElement<String> value) {
        this.suspenseaccountflag = ((JAXBElement<String> ) value);
    }
