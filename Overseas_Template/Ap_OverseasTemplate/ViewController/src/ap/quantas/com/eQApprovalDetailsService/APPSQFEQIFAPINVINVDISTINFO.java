...
public class APPSQFEQIFAPINVINVDISTINFO {
    ...
    @XmlElementRef(name = "LINE_NUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> linenumber;
    @XmlElementRef(name = "LINE_TYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
    protected JAXBElement<String> linetype;
    @XmlElementRef(name = "GL_CODE_COMB", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
