...
public class APPSQFEQIFAPINVINVINFO {
    ...
    @XmlElementRef(name = "REQUESTER_NUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
    protected JAXBElement<String> requesternumber;
    @XmlElementRef(name = "ALTERNET_APPROVER_NUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
    protected JAXBElement<String> alternetapprovernumber;
    @XmlElementRef(name = "INVOICE_AMOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> invoiceamount;
    @XmlElementRef(name = "ORG_ID", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class)
