...
public class Utility {
	...
	public void trackAuditInfo(String soapMsg, String strStatusCode, String strInterfaceId,String operationName,String strSession) 
	{
		...
		try {
        	...
        	//System.out.println("operationName :"+operationName+",Session Obj :"+strSession);		             
			if(conn != null){
				if(operationName != null && !"".equals(operationName) && operationName.endsWith("URL"))
				{
					operationName = "Upload Document Service";
				}else{
					operationName = "Download Document Service";
				}
	...
	public String handleControlChar(String val) throws ServiceException
	{
		return val;
	...
	public Map fetchValueFromDB() throws ServiceException
	{
		Connection conn = null;
	...
	private static String getPropVal(String keyValue){
