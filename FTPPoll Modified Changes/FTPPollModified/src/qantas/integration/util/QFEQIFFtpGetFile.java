 ...
 * @see QFEQIFMoveFile
 */
public class QFEQIFFtpGetFile extends QFEQIFWorkflowBase
{
	private static final Logger logger = QFEQIFLogger.getLogger(QFEQIFFtpGetFile.class.getName());
    ...
    */
    public boolean execute(String FILE_NAME, String TARGET_FOLDER, String ifsAdminUser, String ifsAdminPwd, String ifsService, String ifsSysPwd, String wfFtpHost, String wfFtpPort, String wfFtpUser, String wfFtpPwd, String wfFtpPath, String attrib1, String attrib2, String xferMode)
    {
        ...
        QFEQIFCMSDKUtilSOA ifsUtil = null;
        ...
        try
        {
           ...
           // m_targetFolder = "/u02_psp_soa_ap/DATA" + TARGET_FOLDER; //923018 -Commented for new folder in SIT
            ...
            if(l_isConnected)
            {
                ...
                if(resultOut != QFEQIFConstant.WF_FTP_RCODE_ERROR)
                {
                    ...
                    if(sock!=null)
                    {
                        ...
                        // removing cmsdk
                        QFEIQIFProcedureUtility putility = new QFEIQIFProcedureUtility();
                        boolean rv = putility.writeFile(m_targetFolder, m_fileName, sock.getInputStream());
                        if(!rv)
                        {
                        	logger.info("Return value "+rv);
                        	logger.info("Cannot copy file: "+m_fileName);
                        	resultOut = QFEQIFConstant.WF_FTP_RCODE_ERROR;
                        }
                        // get an instance of iFS
                        /*ifsUtil = new QFEQIFCMSDKUtilSOA(ifsAdminUser, crypto.decrypt(ifsAdminPwd), ifsService, crypto.decrypt(ifsSysPwd));
