...
<link rel="stylesheet" type="text/css" href="css/style_jetstar.css">
...
<div id="div1" class="col-lg-4 panel panel-default customScroll" style="flex: 0 0 auto;max-width:850px;min-width: 150px;padding-right:0px !important;padding-left:0px !important;height:100%;">
  ...
  <div class="panel-body" style="padding-bottom:25px;min-height: 570px;background-color : #F2F2F2;">
	  ...
	  <div class="customDiv" ng-show="showAuditTrail">
  		<div ng-repeat = "item in auditResults">
		  		...
		  		<img alt="arrowIcon" ng-show="{{$index}} != 0" style="padding: 5px;" src="images/down_arrow_icon.PNG">
  		...
  		<!-- <div class="panel panel-success">
    			...
    			<div class="panel panel-success" ng-show="{{item.panelBorderColor == 'red'}}" style="border-color: red;">
			    <div class="panel-body" style="padding : 5px;cursor : pointer;">
			    <span>
			    <img style="padding-right : 8px;" src="images/images.jpg">
    			...
    			<div class="panel panel-success" ng-show="{{item.panelBorderColor == 'green'}}" style="border-color: #00cc00;">
			    <div class="panel-body" style="padding : 5px;cursor : pointer;">
			    <span>
			    <img style="padding-right : 8px;" src="images/new.png">
    ...
    <!-- Vertical Splitter -->
     ...
     <div class="splitter" style="height:auto;width:2px">
		
    </div> 
		
    
    
    <div class="col-lg-8" id="wrapperDiv" style="height:100%;flex: 0 0 auto;display: flex;overflow:hidden;flex-direction: column;">
    
    <!--  Panel Showing Invoice Summary with 4 columns : START -->
    
    <div class="panel panel-default customScroll" id="div2" style="flex: 0 0 auto;max-height:500px;min-width: 250px;padding-right:0px !important;padding-left:0px !important;height:auto;">
    <div class="demoDiv">
        	<div class="panel panel-primary" style="background-color: #F2F2F2;">
					<div class="panel-heading">
    ...
    <div class="panel panel-default customScroll" id="div3" style="flex: 1 1 auto;min-width: 250px;padding-right:0px !important;padding-left:0px !important;height:100%;">
		...
		<table class="table" id="summary-table" ng-show="IsVisible">
						...
						<tbody>
							...
							<tr>
								...
								<td>Employee No</td>
			                    <td>{{detailResult.employeeNumber}}</td>
			                </tr>
							<tr>
	...
	app.controller('myCtrl', function($scope,$http) {
		...
		$scope.init = function(){
        	...
        	if(response.data.length > 0)
        	{
        		...
        		//alert('Inside response 0 length block');
