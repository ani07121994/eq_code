...
public class ImagingUpdateTask {
	...
	// Adding minutes in DATE (10-03-2023 Ask by Kakali)
	private static Date minusMinutesToDate(int minutes, Date beforeTime) {
		final long ONE_MINUTE_IN_MILLIS = 60000;
		long curTimeInMs = beforeTime.getTime();
		Date minusAddingMins = new Date(curTimeInMs - (minutes * ONE_MINUTE_IN_MILLIS));
		return minusAddingMins;
	}
	...
	public void run() {
		...
		if (IS_RUNNING) {
			...
			try {
				...
				// Minus 30 minutes in Date (10-03-2023 Ask by Kakali)
				lastUpdateTimestamp = minusMinutesToDate(30,lastUpdateTimestamp);
				logger.log(Level.INFO, "12c===== new lastUpdateTimestamp updated : " + lastUpdateTimestamp);
				logger.log(Level.INFO, "12c===== new lastUpdateTimestamp format updated : " + DATE_FORMAT.format(lastUpdateTimestamp));
