 ...
 * 
 */
//same wsdl for dev and sit-@WebServiceClient(name = "DocumentContentService", targetNamespace = "http://imaging.oracle/", wsdlLocation = "http://eqdev-capture1:19000/imaging/ws/DocumentContentService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            //url = new URL("http://eqprod-capture1:19000/imaging/ws/DocumentContentService?wsdl");
            url = new URL("http://eqprod-capture1.qantas.com.au:16033/imaging/ws/DocumentContentService?wsdl");
