...
public class Document {
    ...
    @XmlElementRef(name = "fieldValues", type = JAXBElement.class, required = false)
    protected JAXBElement<Document.FieldValues> fieldValues;
    @XmlElementRef(name = "documentPermissions", type = JAXBElement.class, required = false)
    ...
    public void setDocumentPermissions(JAXBElement<DocumentPermissions> value) {
        this.documentPermissions = value;
    }
