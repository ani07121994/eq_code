...
public class OutputParameters {
    ...
    @XmlElementRef(name = "OUT_RESULT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<APPSQFEQIFAPINVAPRVROUTTBLTP> outresult;
    @XmlElementRef(name = "STATUS", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<String> status;
    @XmlElementRef(name = "MESSAGE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
