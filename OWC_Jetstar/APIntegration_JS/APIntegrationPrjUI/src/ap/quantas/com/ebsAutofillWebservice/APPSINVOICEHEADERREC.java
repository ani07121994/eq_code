 ...
 *       &lt;sequence>
 *         &lt;element name="DOCUMENTTYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string200" minOccurs="0"/>
 *         &lt;element name="INVOICETYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string200" minOccurs="0"/>
 *         &lt;element name="ORGID" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="INVOICENUMBER" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string50" minOccurs="0"/>
 ...
 *         &lt;element name="SUPPLIERNAME" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string240" minOccurs="0"/>
 *         &lt;element name="SUPPLIERNUMBER" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string30" minOccurs="0"/>
 *         &lt;element name="SITEID" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="SITENAME" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string15" minOccurs="0"/>
 *         &lt;element name="PONUMBER" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string20" minOccurs="0"/>
 *         &lt;element name="TAXREGISTRATIONNUMBER" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string20" minOccurs="0"/>
 *         &lt;element name="HEADERTAXTOTAL" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="WITHHOLDINGTAX" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string100" minOccurs="0"/>
 *         &lt;element name="INVOICETOTALAMOUNT" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="CURRENCYCODE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string15" minOccurs="0"/>
 *         &lt;element name="CERTIFIERNAME" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string240" minOccurs="0"/>
 *         &lt;element name="CERTIFIEREMPLOYEENO" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string30" minOccurs="0"/>
 *         &lt;element name="CERTIFIEREMAILADD" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string240" minOccurs="0"/>
 *         &lt;element name="INVALIDREASON" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string500" minOccurs="0"/>
 *         &lt;element name="INVALIDCODE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string200" minOccurs="0"/>
 *         &lt;element name="POTYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string25" minOccurs="0"/>
 *         &lt;element name="ALTERNATEAPPROVEREMPLOYEENO" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string240" minOccurs="0"/>
 *         &lt;element name="CERTIFIERCOMMENTS" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string500" minOccurs="0"/>
 *         &lt;element name="INVOICEIMAGEURL" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string300" minOccurs="0"/>
 *         &lt;element name="HEADERATT4" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="HEADERATT5" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="HEADERATT6" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="HEADERATT7" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="HEADERATT8" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="HEADERATT9" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="HEADERATT10" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string1000" minOccurs="0"/>
 *         &lt;element name="IMAGEURL" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string300" minOccurs="0"/>
 *         &lt;element name="PRIORITY" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string50" minOccurs="0"/>
 *         &lt;element name="REASONTYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string300" minOccurs="0"/>
 *         &lt;element name="STATUS" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string300" minOccurs="0"/>
 *         &lt;element name="REJECTIONREASON" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}string300" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class APPSINVOICEHEADERREC {
    ...
    @XmlElementRef(name = "DOCUMENTTYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> documenttype;
    @XmlElementRef(name = "INVOICETYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> invoicetype;
    @XmlElementRef(name = "ORGID", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> orgid;
    @XmlElementRef(name = "INVOICENUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> invoicenumber;
    @XmlElementRef(name = "INVOICEDATE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> invoicedate;
    @XmlElementRef(name = "SUPPLIERID", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> supplierid;
    @XmlElementRef(name = "SUPPLIERNAME", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> suppliername;
    @XmlElementRef(name = "SUPPLIERNUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> suppliernumber;
    @XmlElementRef(name = "SITEID", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> siteid;
    @XmlElementRef(name = "SITENAME", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> sitename;
    @XmlElementRef(name = "PONUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> ponumber;
    @XmlElementRef(name = "TAXREGISTRATIONNUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> taxregistrationnumber;
    @XmlElementRef(name = "HEADERTAXTOTAL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> headertaxtotal;
    @XmlElementRef(name = "WITHHOLDINGTAX", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> withholdingtax;
    @XmlElementRef(name = "INVOICETOTALAMOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> invoicetotalamount;
    @XmlElementRef(name = "CURRENCYCODE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> currencycode;
    @XmlElementRef(name = "CERTIFIERNAME", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> certifiername;
    @XmlElementRef(name = "CERTIFIEREMPLOYEENO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> certifieremployeeno;
    @XmlElementRef(name = "CERTIFIEREMAILADD", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> certifieremailadd;
    @XmlElementRef(name = "INVALIDREASON", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> invalidreason;
    @XmlElementRef(name = "INVALIDCODE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> invalidcode;
    @XmlElementRef(name = "POTYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> potype;
    @XmlElementRef(name = "ALTERNATEAPPROVEREMPLOYEENO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> alternateapproveremployeeno;
    @XmlElementRef(name = "CERTIFIERCOMMENTS", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> certifiercomments;
    @XmlElementRef(name = "INVOICEIMAGEURL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> invoiceimageurl;
    @XmlElementRef(name = "HEADERATT4", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt4;
    @XmlElementRef(name = "HEADERATT5", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt5;
    @XmlElementRef(name = "HEADERATT6", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt6;
    @XmlElementRef(name = "HEADERATT7", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt7;
    @XmlElementRef(name = "HEADERATT8", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt8;
    @XmlElementRef(name = "HEADERATT9", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt9;
    @XmlElementRef(name = "HEADERATT10", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> headeratt10;
    @XmlElementRef(name = "IMAGEURL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> imageurl;
    @XmlElementRef(name = "PRIORITY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> priority;
    @XmlElementRef(name = "REASONTYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> reasontype;
    @XmlElementRef(name = "STATUS", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<String> status;
    @XmlElementRef(name = "REJECTIONREASON", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
