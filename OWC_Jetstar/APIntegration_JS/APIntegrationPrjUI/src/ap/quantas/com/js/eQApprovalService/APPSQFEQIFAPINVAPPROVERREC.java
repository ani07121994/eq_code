 ...
 *       &lt;sequence>
 *         &lt;element name="APP_NAME" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL}string1000" minOccurs="0"/>
 *         &lt;element name="APP_EMAIL" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL}string1000" minOccurs="0"/>
 *         &lt;element name="APP_EMP_NO" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="APP_POSITION" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL}string1000" minOccurs="0"/>
 *         &lt;element name="APP_APPROVE_LIMIT" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="APP_FNDL_CATEGORY" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL}string500" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class APPSQFEQIFAPINVAPPROVERREC {
    ...
    @XmlElementRef(name = "APP_NAME", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
    protected JAXBElement<String> appname;
    @XmlElementRef(name = "APP_EMAIL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
    protected JAXBElement<String> appemail;
    @XmlElementRef(name = "APP_EMP_NO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> appempno;
    @XmlElementRef(name = "APP_POSITION", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
    protected JAXBElement<String> appposition;
    @XmlElementRef(name = "APP_APPROVE_LIMIT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> appapprovelimit;
    @XmlElementRef(name = "APP_FNDL_CATEGORY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
