...
import ap.quantas.com.js_eQApprovalService.APPSQFEQIFAPINVINVDISTTBLTYP;
import ap.quantas.com.js_eQApprovalService.APPSQFEQIFAPINVINVINFO;
 ...
 *       &lt;sequence>
 *         &lt;element name="INV_DETAILS" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL}APPS.QFEQIF_APINV_INV_INFO" minOccurs="0"/>
 *         &lt;element name="INV_DIST_DTL" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL}APPS.QFEQIF_APINV_INV_DIST_TBL_TYP" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InputParameters {
    ...
    @XmlElementRef(name = "INV_DETAILS", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
    protected JAXBElement<APPSQFEQIFAPINVINVINFO> invdetails;
    @XmlElementRef(name = "INV_DIST_DTL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/JSEQ_AP_INV_IMG_PROCESS_APPROVER_DTL", type = JAXBElement.class)
