  ...
  private static DueDateServicePttBindingQSService dueDateService_pttBindingQSService;
    ...
    public static void main(String[] args) {
        try {
            ...
            String invoiceDT = "2016-08-12";
            String calculatedDueDate1 = calculateInvoiceDueDate(supplierId, siteID, invoiceDT);
    ...
    public static String calculateInvoiceDueDate(String supplierId, String siteID, String invoiceDT) {   
