...
public class QFEQIFConstant
{
  ...
  public static final String QFEQIF_LOG_FILE = "/home/applsoa/QFEQIF_LOG_FILE/qfeqif_log_file.log";
  ...
  public static final int IFS_CONNECT_ERROR = 1;
  public static final String TRIM_COMMAND = "dos2unix";
  public static final String CONN_ERROR = "Connection closed";
  public static final String BPEL_PROCESS_SUCCESS = "SUCCESS";
  public static final String BPEL_PROCESS_ERROR = "ERROR";
  public static final int DB_CONNECTION_ERROR = 17008;
}

/* Location:           D:\Workspace\QantasIHubServices\ImportedClasses
 * Qualified Name:     qantas.eq.integration.util.QFEQIFConstant
