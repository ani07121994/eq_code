...
///*    */       url = new URL(baseUrl, "http://eqtest-capture1.qantas.com.au:16033/imaging/ws/SearchService?wsdl");

/* 34 */       url = new URL(baseUrl, "http://eqprod-capture1.qantas.com.au:16033/imaging/ws/SearchService?wsdl"); // Prod
/* 35 */     } catch (MalformedURLException e) {
	/* 60 */       System.out.println(" MalformedURLException SearchService");
	/*    */     } 
				 catch (Exception e) {
	/* 60 */       System.out.println(" Exception SearchService");
	/*    */     } 
...
/* Location:              C:\Users\2033471\techstack_ugrade_jetstar\JS_Ap_AutoReject_mailSender.ear!\JS_EmailSender-JS_EmailSenderProj-context-root.war!\WEB-INF\classes\ap\quantas\com\imaging\documentSearchService\SearchService_Service.class
