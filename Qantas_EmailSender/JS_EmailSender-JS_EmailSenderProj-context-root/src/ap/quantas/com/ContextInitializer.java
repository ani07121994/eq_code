...
/*  43 */       jndi_name = "jdbc/CRP2_APPS_NXA";
...
/*  67 */       rs = conn.createStatement().executeQuery("select * from ap_properties_table");
/*  68 */       int n = 1;
/*  69 */       while (rs.next()) {
/*  70 */         System.out.println("Record-" + n++);
/*  71 */         PropertyLoader.getInstance().addProperty(rs.getString(1), rs.getString(2));
/*     */       } 
/*  75 */       rs2 = conn.createStatement().executeQuery("select * from ap_email_table");
/*  76 */       while (rs2.next())
...
/* Location:              C:\Users\2033471\Downloads\Ap_AutoReject_mailSender.ear!\JS_EmailSender-JS_EmailSenderProj-context-root.war!\WEB-INF\classes\ap\quantas\com\ContextInitializer.class
