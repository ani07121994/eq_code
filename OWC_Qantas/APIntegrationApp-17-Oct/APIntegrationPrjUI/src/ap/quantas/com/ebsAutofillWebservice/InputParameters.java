 ...
 *       &lt;sequence>
 *         &lt;element name="P_INVOICE_IN" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}APPS.INVOICE_HEADER_REC" minOccurs="0"/>
 *         &lt;element name="P_INV_LINE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update}APPS.INVOICE_IN_TBL_TYPE" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InputParameters {
    ...
    @XmlElementRef(name = "P_INVOICE_IN", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
    protected JAXBElement<APPSINVOICEHEADERREC> pinvoicein;
    @XmlElementRef(name = "P_INV_LINE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/Update", type = JAXBElement.class)
