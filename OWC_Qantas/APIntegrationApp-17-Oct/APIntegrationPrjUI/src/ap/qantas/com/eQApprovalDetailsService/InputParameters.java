...
public class InputParameters {
    ...
    @XmlElementRef(name = "INV_DETAILS", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<APPSQFEQIFAPINVINVINFO> invdetails;
    @XmlElementRef(name = "INV_DIST_DTL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
