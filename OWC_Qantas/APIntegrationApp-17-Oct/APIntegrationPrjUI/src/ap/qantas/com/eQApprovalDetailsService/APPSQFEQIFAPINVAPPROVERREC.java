...
public class APPSQFEQIFAPINVAPPROVERREC {
    ...
    @XmlElementRef(name = "APP_NAME", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<String> appname;
    @XmlElementRef(name = "APP_EMAIL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<String> appemail;
    @XmlElementRef(name = "APP_EMP_NO", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> appempno;
    @XmlElementRef(name = "APP_POSITION", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<String> appposition;
    @XmlElementRef(name = "APP_APPROVE_LIMIT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> appapprovelimit;
    @XmlElementRef(name = "APP_FNDL_CATEGORY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
