 ...
 *         &lt;element name="LINE_TYPE" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails}string200" minOccurs="0"/>
 *         &lt;element name="GL_CODE_COMB" type="{http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails}string500" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class APPSQFEQIFAPINVINVDISTINFO {
    ...
    @XmlElementRef(name = "LINE_NUMBER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> linenumber;
    @XmlElementRef(name = "LINE_TYPE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
    protected JAXBElement<String> linetype;
    @XmlElementRef(name = "GL_CODE_COMB", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/approverDetails", type = JAXBElement.class, required = false)
