...
public class QFEQIFCryptoSOAIOFilePoll{

	private static final Logger logger = QFEQIFLoggerIOFilePoll.getLogger(QFEQIFCryptoSOAIOFilePoll.class.getName());
    private Connection m_conn = null;
    private final String CLASS_NAME = getClass().getName();
	
    public QFEQIFCryptoSOAIOFilePoll(Connection p_conn)
    {   
        m_conn = p_conn;
    }
	
    public QFEQIFCryptoSOAIOFilePoll()
    {
