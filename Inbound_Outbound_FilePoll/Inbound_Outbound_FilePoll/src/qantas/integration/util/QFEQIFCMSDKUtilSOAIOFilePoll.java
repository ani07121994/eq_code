 ...
 */
public class QFEQIFCMSDKUtilSOAIOFilePoll
{
	private static final Logger logger = QFEQIFLoggerIOFilePoll.getLogger(QFEQIFCMSDKUtilSOAIOFilePoll.class.getName());
    ...
    boolean m_errorFlag = false;
      ...
      *
      */
	public QFEQIFCMSDKUtilSOAIOFilePoll(String p_ifsAdminUser, String p_ifsAdminPwd, String p_ifsService, String p_ifsSysPwd)
	{
	    m_ifsSysPwd = p_ifsSysPwd;
	    m_session = createLibrarySession(p_ifsAdminUser, p_ifsAdminPwd, p_ifsService, p_ifsSysPwd);
	}

	public QFEQIFCMSDKUtilSOAIOFilePoll(LibrarySession p_libs)
	{
		m_session = p_libs;
	}
	  
	public QFEQIFCMSDKUtilSOAIOFilePoll()
	{
	}
  ...
  */
	public boolean createDocStream(String p_filePath, String p_fileName, InputStream p_contentStream) throws IfsException, IOException
	{
	    ...
	    try {
	    	po = ifs.findPublicObjectByPath(p_filePath + QFEQIFConstantIOFilePoll.PATH_DELIMITER + p_fileName);
