 ...
 * @see QFEQIFMoveFile
 */
public class QFEQIFFtpGetFirstFileNameIOFilePoll extends QFEQIFWorkflowBaseIOFilePoll
{
    //private static final Logger logger = Logger.getLogger("fout");
	private static final Logger logger = QFEQIFLoggerIOFilePoll.getLogger(QFEQIFFtpGetFirstFileNameIOFilePoll.class.getName());
    ...
    */
     ...
     */
    public boolean isInTransitFile(String fileName, QFEQIFFtpClientIOFilePoll ftpClient, String wfFtpPath){
     ...
     */
    public String getFileModificationTime(String fileName, QFEQIFFtpClientIOFilePoll ftpClient, String wfFtpPath){
