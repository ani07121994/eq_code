...
public class TriggerAppServletIOFilePoll extends HttpServlet {
    private static final String CONTENT_TYPE = "text/html; charset=windows-1252";

    public void init(ServletConfig config) throws ServletException {
        System.out.println("***********************Starting Inbound Outbound File Poll Program**************************");
        super.init(config);
        AppMonitorIOFilePoll pollFTP = AppMonitorIOFilePoll.getInstance();
