...
public class QFEQIFDatabaseConnIOFilePoll {
	
    private static Connection connect;
    private static QFEQIFDatabaseConnIOFilePoll instance;
    private static final Logger logger = QFEQIFLoggerIOFilePoll.getLogger(QFEQIFDatabaseConnIOFilePoll.class.getName());
    private QFEQIFDatabaseConnIOFilePoll()
    {
    ...
    public static Connection getConnection()
    {
      ...
      if(instance  == null) {
          ...
          instance=new QFEQIFDatabaseConnIOFilePoll();
      }
